...
RUN apt-get install -y musl-dev && \
    ...
    pip install --no-cache-dir "llama-cpp-python @ https://github.com/kuwaai/llama-cpp-python/releases/download/v0.3.8/llama_cpp_python-0.3.8-cp310-cp310-linux_$(uname -m).whl"
