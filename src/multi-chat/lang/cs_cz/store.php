...
return [
    ...
    'bot.before_response' => 'Předpona výzvy uživatele pro výstupní bota',
    'bot.after_response' => 'Přípona výzvy uživatele pro výstupní bota',
    'bot.before_response.label' => 'Tato výzva bude přidána před výzvu uživatele pro výstupní bota',
    'bot.after_response.label' => 'Tato výzva bude přidána za výzvu uživatele pro výstupní bota',
