...
return [
    'route' => 'Datei',
    'header.interface' => 'Cloud-Dateiverwaltung',
    ...
    'label.cannot_preview' => 'Leider können wir diese Datei derzeit nicht direkt anzeigen. Wenn Sie fortfahren, wird die Datei in einem neuen Tab geöffnet, was jedoch möglicherweise einen automatischen Download auslöst. Achten Sie darauf, dass Sie keine unbekannten ausführbaren Dateien oder Installationsdateien ausführen.',
];