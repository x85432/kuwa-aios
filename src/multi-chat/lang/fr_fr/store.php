...
return [
    ...
    'hint.must_enter_input_bot' => 'Vous devez spécifier un Bot d’entrée',
    ...
    'bot.output_prefix' => 'Préfixe d\'invite utilisateur pour le « Bot de sortie »',
    'bot.output_suffix' => 'Suffixe d\'invite utilisateur pour le « Bot de sortie »',
    'bot.output_prefix.label' => 'Cette invite sera ajoutée avant l\'invite utilisateur pour le « Bot de sortie »',
    'bot.output_suffix.label' => 'Cette invite sera ajoutée après l\'invite utilisateur pour le « Bot de sortie »',
    'bot.input_prefix' => 'Préfixe d\'invite utilisateur pour le « Bot d\'entrée »',
    'bot.input_suffix' => 'Suffixe d\'invite utilisateur pour le « Bot d\'entrée »',
    'bot.input_prefix.label' => 'Cette invite sera ajoutée avant l\'invite utilisateur pour le « Bot d\'entrée »',
    'bot.input_suffix.label' => 'Cette invite sera ajoutée après l\'invite utilisateur pour le « Bot d\'entrée »',
    ...
    'bot.output_bot.label' => 'Sélectionnez le Bot de sortie, chargé de traiter la sortie du Bot',
    'bot.input_bot' => 'Bot d’entrée',
