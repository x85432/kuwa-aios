...
return [
    ...
    'bot.before_response' => '「輸出Bot」的使用者前提示詞',
    'bot.after_response' => '「輸出Bot」的使用者後提示詞',
    'bot.before_response.label' => '此提示詞會在加在「輸出Bot」的使用者提示詞前面',
    'bot.after_response.label' => '此提示詞會在加在「輸出Bot」的使用者提示詞後面',
    'bot.knowledge' => '知識庫',
