...
<div class="w-full overflow-hidden flex">
    ...
    <form method="get"
        ...
        <label for="inspect_start_date" class="block uppercase tracking-wide dark:text-white">{{ __('dashboard.inspect.begin_date') }}</label>
        <input type="datetime-local" placeholder="{{ __('dashboard.inspect.begin_date') }}" id="inspect_start_date" name="start_date"
            value="{{ session('start_date') }}" onchange="$(this).closest('form').submit()"
            class="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
        <label for="inspect_end_date" class="block uppercase tracking-wide dark:text-white">{{ __('dashboard.inspect.end_date') }}</label>
        <input type="datetime-local" placeholder="{{ __('dashboard.inspect.end_date') }}" id="inspect_end_date" name="end_date"
            value="{{ session('end_date') }}" onchange="$(this).closest('form').submit()"
            class="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
        <label for="inspect_searchbox" class="block uppercase tracking-wide dark:text-white">{{ __('dashboard.inspect.search_msg') }}</label>
        <input placeholder="{{ __('dashboard.inspect.filter_content') }}" id="inspect_searchbox" name="search" value="{{ session('search') }}"
            autocomplete="off"
            class="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
        <div id="inspect_targetInputsContainer"></div>
        <div class="flex flex-wrap -mx-3">
            <div class="w-full px-3">
                <label for="inspect_tagInput" class="block uppercase tracking-wide dark:text-white">{{ __('dashboard.inspect.filter_model') }}</label>
                <div class="relative mt-1">
                    <div id="inspect_tagContainer" class="mt-2 flex flex-wrap">
                        <input id="inspect_tagInput" type="text"
                            ...
                            placeholder="{{ __('dashboard.inspect.please_select_model') }}">
                    </div>
