...
set "url_PHP=https://windows.php.net/downloads/releases/php-8.1.31-Win32-vs16-x64.zip"
...
set "url_PHP_Archive=https://windows.php.net/downloads/releases/archives/php-8.1.31-Win32-vs16-x64.zip"
